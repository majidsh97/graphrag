...
-Goal-
Given a text document and some entity candidates, identify ALL entities from the text and ALL relationships among the identified entities.
entity candidates:
{entity_seed}
-Steps-
1. Identify ALL entities and ADD to the entity candidates. For each identified entity, extract the following information:
- entity_name: Name of the entity, capitalized
- entity_type: Class the entity belongs to, it has to be as specefic as possible
